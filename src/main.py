...
async def cantidad_filmaciones_mes():
    print(10, 'peliculas fueron extrenadas en el mes de', 'Octubre')


@app.get("/")
async def cantidad_filmaciones_dia():
    print(2, 'peliculas fueron estrenadas en los días', 'martes')


@app.get("/")
async def score_titulo():
    print('La película', 'Star Wars, La Venganza de los Sith', 'fue estrenada en el año', \
        2005, 'con un score/popularidad de', 85.5)


@app.get("/")
async def votos_titulo():
    print('La película', 'Star Wars, La Venganza de los Sith', 
...
@app.get("/")
async def get_actor():
    print('El actor', 'Pedro', 'ha participado en', 20, 
...
async def get_director():
    print('El director', 'Juan', 'que ha obtenido un exito que medido en dolares es de', 
